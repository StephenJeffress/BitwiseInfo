...
dockfigs = 0;
%savedir = '~/public_html/';
savedir = '/home/jeffress/Documents/Publications/BitwiseInfo/20Oct2016/';
...
p1baseline  p2b32_t1 p3b32_t1 q2b32_t1 q3b32_t1 ...
    ...
    X Xp X2p X3p X4p fnum bits2 bits3 bits4;
...
plot(dt*(1:Plotlength),X2p(1,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
hold off
ylim([-1 1]*45)
xlim([0 1]*15)
box on
...
line(5+[.7 2],[1 1]*30.5,'color',[1 1 1]*.7);
...
hold on
plot(dt*(1:Plotlength),X(1,1:Plotlength),'k'); 
plot(dt*(1:Plotlength),X3p(1,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
hold off
ylim([-1 1]*45)
xlim([0 1]*15)
box on
...
line(0+[.7 2],[1 1]*30.5,'color',[1 1 1]*.7);
...
hold on
plot(dt*(1:Plotlength),X(1,1:Plotlength),'k'); 
plot(dt*(1:Plotlength),X4p(1,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
hold off
ylim([-1 1]*45)
xlim([0 1]*15)
box on
...
hold on
plot(Bins2,pdfXp,'k');
plot(Bins2,pdfX2p,'color',[1 1 1]*.7,'linestyle','-');
xlim([-1 1]*22)
ylim([0 .02]);
...
line(min(xlim)+13+[1.5 4.5],[1 1]*.835*max(ylim),'color',[1 1 1]*.7);
text(min(xlim)+18.25,.835*max(ylim),'$p(x''_{12\:bit})$','interpreter','latex','horizontalalignment','left','fontsize',10,'color','k');


% line([.1 .28]*max(xlim), [1 1]*.88*max(ylim) ,'color',[1 1 1]*.7)
% text(.3*max(xlim),.88*max(ylim),'14-bit $X(t)\:$', ... 
%     'interpreter','latex','horizontalalignment','left', ...
%     'fontsize',8)
%text(mean(xlim),max(ylim)+.1*range(ylim),'PDF','interpreter','latex','horizontalalignment','center','fontsize',10)


axes('position',[bxlf+1*bxwd+1*bxpw bxbt+bxht+bxpu bxwd bxht])
hold on
plot(Bins2,pdfXp,'k');
plot(Bins2,pdfX3p,'color',[1 1 1]*.7,'linestyle','-');
xlim([-1 1]*22)
ylim([0 .02]);
set(gca,'xtick',[-15 0 15]); set(gca,'xticklabel',{'-15' '0' '15'}); 
set(gca,'ytick',[.2 .5 .8]*max(ylim));set(gca,'yticklabel',[]);
...
hold on
plot(Bins2,pdfXp,'k');
plot(Bins2,pdfX4p,'color',[1 1 1]*.7,'linestyle','-');
xlim([-1 1]*22)
ylim([0 .024])
set(gca,'xtick',[-15 0 15]); set(gca,'xticklabel',{'-15' '0' '15'}); 
set(gca,'ytick',[.2 .5 .8]*max(ylim));set(gca,'yticklabel',[]);
...
%grid on
% line([.1 .28]*max(xlim), [1 1]*.88*max(ylim) ,'color',[1 1 1]*.7)
% text(.3*max(xlim),.88*max(ylim),'18-bit $X(t)\:$', ... 
%     'interpreter','latex','horizontalalignment','left', ...
%     'fontsize',8)
...
semilogx((1:length(Diff2f))*dt,Diff2f/fnum,'color',[1 1 1]*.7,'linestyle','-','linewidth',1);
hold off
xlim([.05 30]);
ylim([0 25]);
...
%box on
line([.06 .09],[1 1]*.835*max(ylim),'color',[1 1 1]*.7);
...
semilogx((1:length(Diffpf))*dt,Diffpf/fnum,'color','k','linestyle','-','linewidth',1); hold on
semilogx((1:length(Diff2f))*dt,Diff3f/fnum,'color',[1 1 1]*.7,'linestyle','-','linewidth',1);
hold off
xlim([.05 30]);
ylim([0 25]);
set(gca,'ytick',[0 5 10 15 20]);
...
axes('position',[bxlf+2*bxwd+2*bxpw bxbt+0*bxht+0*bxpu bxwd bxht])
semilogx((1:length(Diffpf))*dt,Diffpf/fnum,'color','k','linestyle','-','linewidth',1); hold on
semilogx((1:length(Diff2f))*dt,Diff4f/fnum,'color',[1 1 1]*.7,'linestyle','-','linewidth',1);
hold off
xlim([.05 30]);
ylim([0 25]);
%set(gca,'xticklabel',[ ]); %set(gca,'ytick',[ ]);
...
%draw bit boxes
axes('position',[bxlf-2*bxpw bxbt+bxht+1.1*bxpu 1.2*bxpw .98*bxht]);
bxclr = ones(1,Numbits);
bxclr(Numbits-4:Numbits-2)=.7;
%bxclr(1:bits3-10)=.7;
bxclr(1:bits3)=.7;
...
%xlabel
text(1.03*mean(xlim),max(ylim)+.07*range(ylim),'Forecast time ($\tau$)','interpreter','latex','fontsize',10,'horizontalalignment','center');
%title
...
text(double(-.68*max(xlim)),double(.73*max(ylim)),'$p(x \:| \:x_b(t-\tau) = 1 )$', ... 
     'interpreter','latex','horizontalalignment','left', ...
     'fontsize',10)
line([-.9 -.75]*max(xlim), [1 1]*.59*max(ylim) ,'color',[1 1 1]*.7)
...
plot(T1colonPln,X1pcolonPln,'color',[1 1 1]*.7,'linestyle','-'); hold off;
ylim([-1 1]*30)
...
line(0+[.7 2],[1 1]*24.5,'color','k');
text(2.25,25,'$x(t)$','interpreter','latex','horizontalalignment','left','fontsize',10);
line(5+[.7 2],[1 1]*24.5,'color',[1 1 1]*.7);
...
yl = ylim;
xlabel('Time (mtu)','fontsize',10);
tmp = ylabel('$x_b(t)$','interpreter','latex');
...
plot(Bins,Xsign0pdf,'color',[1 1 1]*.7,'linestyle','-'); 
...
text(-.75*max(xlim),.82*max(ylim),'$p(x \:| \:x_0(t) = 1 )$', ... 
    'interpreter','latex','horizontalalignment','left', ...
    'fontsize',8)
line([-.95 -.77]*max(xlim), [1 1]*.72*max(ylim) ,'color',[1 1 1]*.7)
text(-.75*max(xlim),.72*max(ylim),'$p(x \:| \:x_0(t) = 0)$', ... 
...
Bins = [-fliplr(bwid/2:bwid:abs(min(tv))+bwid/2) (bwid/2:bwid:abs(max(tv))+bwid/2)];
cv = squeeze(Xb(1:length(tv),bnum));
bitinfoplot4(tv,cv,Bins);box on; set(gca,'xtick',[-15 0 15]); set(gca,'xticklabel',[-15 0 15]);
yl = double(ylim);
yl(2) = 1.2*yl(2);
ylim(yl);
...
line([-.35 -.17]*max(xlim), [1 1]*.88*max(ylim) ,'color','k')
text(-.15*max(xlim),.88*max(ylim),'$P[\: X(t) \:| \:{\rm Sign} = 1 \:]$', ... 
    'interpreter','latex','horizontalalignment','left', ...
    'fontsize',8)

line([-.35 -.17]*max(xlim), [1 1]*.78*max(ylim) ,'color',[1 1 1]*.7)
text(-.15*max(xlim),.78*max(ylim),'$P[\: X(t) \:| \:{\rm Sign} = 0 \:]$', ... 
    'interpreter','latex','horizontalalignment','left', ...
    'fontsize',8)
...
axes('position',[bxlf bxbt+2*bxht+2*bxpu 2*bxwd+bxpu bxht])
hold on
plot(T(1:Plotlength),X(1,1:Plotlength),'k'); 
plot(T(1:Plotlength),Xp(1,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
hold off
box on
set(gca,'xtick',[]);
ylim([-1 1]*30)
text(mean(xlim),max(ylim)+.07*range(ylim),'Timeseries','interpreter','latex','horizontalalignment','center')

axes('position',[bxlf bxbt+bxht+bxpu 2*bxwd+bxpu bxht])
hold on
plot(T(1:Plotlength),X(2,1:Plotlength),'k');
plot(T(1:Plotlength),Xp(2,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
hold off
box on
set(gca,'xtick',[]);
ylim([-1 1]*30)
...
axes('position',[bxlf bxbt 2*bxwd+bxpu bxht])
hold on
plot(T(1:Plotlength),X(3,1:Plotlength),'k');
plot(T(1:Plotlength),Xp(3,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
hold off
box on
ylim([0 1]*50)
...
axes('position',[bxlf+2*bxwd+2*bxpu bxbt+2*bxht+2*bxpu bxwd bxht])
tv = X(1,:);
Bins = [-fliplr(bwid/2:bwid:abs(min(tv))+bwid/2) (bwid/2:bwid:abs(max(tv))+bwid/2)];
%bins = [-fliplr(bwid:bwid:abs(min(tv))+bwid) (0:bwid:abs(max(tv))+bwid)];
pdf = single(hist(tv,Bins));
pdf = pdf./sum(pdf);
plot(Bins,pdf,'k');
set(gca,'yaxislocation','right');
xlim([-1 1]*30)
ylim([0 1.2]*double(max(pdf)));
set(gca,'xtick',[]);
text(mean(xlim),max(ylim)+.07*range(ylim),'PDF','interpreter','latex','horizontalalignment','center')

axes('position',[bxlf+2*bxwd+2*bxpu bxbt+bxht+bxpu bxwd bxht])
tv = X(2,:);
Bins = [-fliplr(bwid/2:bwid:abs(min(tv))+bwid/2) (bwid/2:bwid:abs(max(tv))+bwid/2)];
pdf = single(hist(tv,Bins));
pdf = pdf./sum(pdf);
...
axes('position',[bxlf+2*bxwd+2*bxpu bxbt bxwd bxht])
tv = X(3,:);
Bins = [-fliplr(bwid/2:bwid:abs(min(tv))+bwid/2) (bwid/2:bwid:abs(max(tv))+bwid/2)];
pdf = single(hist(tv,Bins));
pdf = pdf./sum(pdf);
...
%    
  ...
  %if mod(i,fcasn)==0;
        ...
        for nk = 1:3
            ...
            %tmp0 = tmp0 + (X(nk,trng)-X(nk,trng(1))).^2;
            
%             Diff0f = Diff0f + abs(X(nk,trng)-X(nk,trng(1)));
%             Diffpf = Diffpf + abs(Xp(nk,trng)-X(nk,trng));
%             Diff2f = Diff2f + abs(X2p(nk,trng)-X(nk,trng));
%             Diff3f = Diff3f + abs(X3p(nk,trng)-X(nk,trng));
%             Diff4f = Diff4f + abs(X4p(nk,trng)-X(nk,trng));
%             
...
%         
        ...
        %X(:,1) = X(:,round(i/20))+psize*randn(3,1);
...
clf
plot(X(1,1:nln),'color','k');
hold on
plot(Xp(1,1:nln),'color',[1 1 1]*.8);
hold off
...
tv = X2p(1,:);
pdf2p = pdf2p+double(hist(tv,bins2));

tv = X3p(1,:);
pdf3p = pdf3p+double(hist(tv,bins3));

tv = X4p(1,:);
pdf4p = pdf4p+double(hist(tv,bins4));
...
axes('position',[bxlf bxbt+1*bxht+1*bxpu 2*bxwd+bxpu bxht])
hold on
plot(T(1:Plotlength),X2(1,1:Plotlength),'k'); 
plot(T(1:Plotlength),Xp(1,1:Plotlength),'color',[1 1 1]*.7,'linestyle','-'); hold off;
ylim([-1 1]*25)
set(gca,'xtick',[0:5:25]);
set(gca,'ytick',[-20 -10 0 10 20]);
set(gca,'xticklabel',[]);
grid on
text(mean(xlim),max(ylim)+.05*range(ylim),'Timeseries of $X(t)$','interpreter','latex','horizontalalignment','center','fontsize',10)
hold off
box on
...
ylim(yl);
xlim([0 1])
line(xlim,[0 0]+.5,'color','k');
%line(xlim,[32 32]+.5,'color','k');
line(xlim,[31 31]+.5,'color','k');
line(xlim,[23 23]+.5,'color','k');

text(.6,32.5,'Sign','interpreter','latex', ...
    'horizontalalignment','right', ...
    'rotation',0, ...
    'fontsize',6);

text(.2,30.75,'Exponent','interpreter','latex', ...
    'horizontalalignment','right', ...
    'rotation',90, ...
    'fontsize',6);

text(.2,16.5,'Fraction','interpreter','latex', ...
    'horizontalalignment','right', ...
    'rotation',90, ...
    'fontsize',6);
...
xlim([-1 1]*22)
ylim([0 .02]);
set(gca,'xtick',[-15 0 15]); set(gca,'xticklabel',[]);
set(gca,'yaxislocation','right');
set(gca,'ytick',[0 .01 .02]);

text(mean(xlim),max(ylim)+.05*range(ylim),'PDF','interpreter','latex','horizontalalignment','center','fontsize',10)

line([.2 .38]*max(xlim), [1 1]*.9*max(ylim) ,'color','k')
text(.4*max(xlim),.9*max(ylim),'$P[\: X(t) \:]$', ... 
    'interpreter','latex','horizontalalignment','left', ...
    'fontsize',8)
...
pdf(pdf==0) = .000000001;
entr1 = sum(-pdf.*log2(pdf));
entstr = ['$H=\:$' num2str(entr1,'%1.2f')];
text(mean(xlim),min(ylim)+.12*range(ylim),entstr,'interpreter','latex', ... 
    'horizontalalignment','center','fontsize',8)


%saveas(gcf,'l63fig5.pdf');
